                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="data:image/png;base64,{{$user->picture ? $user->picture : 'assets/images/users/user-dummy-img.jpg'}}"
                                alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form method="POST" action="{{ route('logout') }}" enctype="multipart/form-data">
                            ...
                            <button class="dropdown-item" type="submit">
                                <i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> Logout</button>
                        </form>
                    </div>
                </div>
            </div>
